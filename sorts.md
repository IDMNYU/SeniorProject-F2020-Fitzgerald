...
Card sorting is about creating associations between information. Complete the following steps and take pictures of your cards at the end of each step. Post the results to your project website.
...
* Upload your photos to your documentation website.
...
Choose a third color of card and create three enabler cards for each project. The enabler cards are underlying traits that enable the project to exist -- the technology, software, circumstance, environment, or tools that are needed for the project. For a painting, enabler cards would be paint, brushes, easel, subject, canvas, or light. \(It is OK to use more than the suggested amount of cards.\) If you are unsure about a particular technology, guess what it might be and write that down.
...
Figure out which of these ideas speak most strongly to you. Make a ranked list of the idea cards. Ask yourself why you choose those cards, and why the idea is interesting to you. Take photos and notes and post to your documetnation website.
